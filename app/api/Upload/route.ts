...
export async function POST(req: Request) {
  ...
  try{
    ...
    if (typeof file === 'object' && file instanceof Blob && typeof name === 'string' && contract !== null) {
        ...
        const Directorio = path.join(process.cwd(), `app/Contratacion_copy/ADMIN/Secretaria/Clases_contrataciones/${contract}/Licitaciones`, Dirname ,carpetanumerada);
