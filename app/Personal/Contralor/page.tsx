    ...
    <div className='FotoLadodiv'>
      <div className='text'>
        ...
        <div className='Paragraph'>
          ...
          <div className='Sspan'> Solicitar a la Contraloría Municipal las capacitaciones que estime necesarias para el adecuado desarrollo de las funciones que corresponden a la Contraloría Escolar.</div><br/>

          <div className='Sspan'> Establecer con el acompañamiento de la secretaría de educación municipal o la autoridad escolar designada por el rector de la institución educativa, mediante documento técnico, las normas de audite pedagógico de contratos o programas que sean ejecutados en el ambiente escolar.</div><br/>

          <div className='Sspan'> Someter a aprobación de la Contraloría el documento técnico que contiene las normas de audite pedagógico que se establezcan con las autoridades mencionadas en el numeral anterior.</div><br/>
              ...
              { Json ?
                Json.map((data) => (
                  <div className= 'containerPersonero' key={data.id}>
                    <Image className='fotoPers' src={ImagenesPersoneros[data.ImageRoute]} width="100" height="100" alt="foto personero"/>
