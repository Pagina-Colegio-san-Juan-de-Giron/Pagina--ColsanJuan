...
const Filepath = "app/Componentes/PDF"
...
<nav className={` ${cerrado ? 'Nav flex w-0 ' : 'Nav flex h-full w-full abierto' }`}>
  <ul className={` ${cerrado ? 'menu hidden ' : 'translate-x-0'} pt-[15vh] bg-F-blue select-none list`} onMouseLeave={Close}>
   ...
   <Link href="/"><li className="justify-center">Inicio</li></Link>
      ...
      <li className="justify-center">Normativas
        ...
        <span><span className="linea"></span></span>
              ...
              <Link href={`/api/Preview?Filepath=${Filepath}&Filename=${filename}`} target="_blank" rel="noopener noreferrer"><li>Manual de<br/>convivencia</li></Link> 
